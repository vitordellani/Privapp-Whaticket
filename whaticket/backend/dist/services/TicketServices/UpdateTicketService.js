...
const UpdateTicketService = ({ ticketData, ticketId }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // If ticket moved to pending, notify opted users
    try {
        if (status === "pending" && oldStatus !== "pending") {
            const NotifyOnTicketPending_1 = require("../NotificationService/NotifyOnTicketPending");
            setImmediate(() => { (0, NotifyOnTicketPending_1.default)(ticket.id, true); });
        }
    }
    catch (e) {
        // ignore
